...
const CommandInput = styled.input`
    ${tw`text-sm transition-colors duration-150 px-2 bg-transparent border-0 border-b-0 border-transparent text-white p-2 pl-0 w-full focus:ring-0`}
    margin-top: .105rem;
`;
...
export default () => {
    ...
    return (
        <div css={tw`text-xs mt-4 font-mono relative`}>
            ...
            {canSendCommands &&
            <div css="align-items: baseline; padding-bottom: .37rem; padding-top: .4rem; color: white; display: flex; background: #3D3656;">

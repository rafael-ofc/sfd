...
const StyledRow = styled.div<{ $danger?: boolean }>`
    ...
    ${props => props.$danger ? tw`hover:bg-neutral-900 hover:text-red-700` : tw`hover:bg-neutral-900 hover:text-white`};
`;
...
const Row = ({ icon, title, ...props }: RowProps) => (
    <StyledRow {...props}>
        <FontAwesomeIcon icon={icon} css={tw`text-xs text-neutral-915`} fixedWidth/>
        <span css={tw`ml-2 text-white`}>{title}</span>
    </StyledRow>
);
        ...
        <>
            ...
            <DropdownMenu
                ...
                renderToggle={onClick => (
                    <div css={tw`p-3 text-white hover:text-neutral-915`} onClick={onClick}>

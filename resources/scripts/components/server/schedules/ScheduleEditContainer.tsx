...
const ActivePill = ({ active }: { active: boolean }) => (
    <span
        css={[
            ...
            active ? tw`bg-neutral-910 text-white` : tw`bg-neutral-910 text-white`,
        ]}
    >
            ...
            {!schedule || isLoading ?
                ...
                <>
                    ...
                    <div css={tw`rounded shadow`}>
                        <div css={tw`sm:flex items-center bg-neutral-700 p-3 sm:p-6 border-b-4 border-neutral-910 rounded-t`}>
                            <div css={tw`flex-1`}>
                                ...
                                <p css={tw`mt-1 text-sm text-white`}>
                                    ...
                                    <span css={tw`ml-4 pl-4 border-l-4 border-neutral-910 py-px`}>
                                        Next run at:&nbsp;
                                        {schedule.nextRunAt ?

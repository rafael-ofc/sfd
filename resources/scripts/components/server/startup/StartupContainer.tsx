    ...
    return (
        !data ?
            (!error || (error && isValidating)) ?
                ...
                />
            :
            <ServerContentBlock css="padding-left: 170px;" className="startupContainer" title={'Startup Settings'} showFlashKey={'startup:image'}>
                <div css={tw`md:flex`}>
                    <TitledGreyBox title={'Startup Command'} css={tw`text-white flex-1`}>
                        <div css={tw`px-1 py-2`}>
                            <p css={tw`text-white font-mono bg-neutral-900 rounded py-2 px-4`}>
                                {data.invocation}
                            </p>
                        </div>
                    </TitledGreyBox>
                ...
                <h3 css={tw`mt-8 text-white mb-2 text-2xl`}>Variables</h3>

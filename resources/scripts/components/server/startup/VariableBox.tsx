...
const VariableBox = ({ variable }: Props) => {
    ...
    return (
        <TitledGreyBox
            title={
                <p css={tw`text-white text-sm uppercase`}>
                    {!variable.isEditable &&
                    <span css={tw`bg-neutral-915 text-white text-xs py-1 px-2 rounded-full mr-2 mb-1`}>Read Only</span>
                    }
                    {variable.name}
                </p>
            }
        >
            ...
            <p css={tw`mt-1 text-xs text-white`}>
